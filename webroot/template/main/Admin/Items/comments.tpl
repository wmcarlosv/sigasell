    ...
    <div class="layout-content">
        <div class="layout-content-body">
          ...
          <h1 class="title-bar-title">
            <span class="d-ib"><div class="fa fa-comment"></div> Comments</span>
          </h1>
     ...
     {if $do_error}<div class="alert alert-danger">Error: Somthing Wrong! Please Try again.</div>{/if}
       ...
       <div class="row">
             ...
             <table class="table table-middle">
              <thead>
               <tr>
                ...
                <th style="text-align: center"><div class="fa fa-comment"></div> Comment</th>
            ...
            {foreach from=$comments item=foo}
                 ...
                 <td style="text-align: center;font-size: 14px;">{$foo['comment']}</td>
 ...
 {else}
  ...
  <center><span class="alert alert-danger text-center">No comments to show...</span></center>
