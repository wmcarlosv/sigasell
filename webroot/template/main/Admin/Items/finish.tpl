        ...
        <div class="layout-content-body">
            <div class="title-bar">
                ...
                <h1 class="title-bar-title">
                    <span class="d-ib"><div class="fa fa-check"></div> Finish <em>(Files)</em></span>
                </h1>
                
 {include file='../Items/menu.tpl'}
 
            {if $added}<div class="alert alert-success">Item Has Been Added! Need To Finish This Step.</div>{/if}
                    ...
                    <form id="changeDataVO" class="form form-horizontal" data-toggle="validator" method="POST" enctype="multipart/form-data">
                        ...
                        <div class= "form-group">  
                            <div class="col-sm-1 col-sm-offset-1">
                                ...
                                <br>
                                <button class="btn btn-info" name="finish" type="submit" value="FINISH"><i class="fa fa-check"></i> FINISH</button>
